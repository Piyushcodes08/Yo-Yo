...
import contacting from "../assets/images/contactimg.jpg"
import AOS from 'aos';
...
<textarea name="" id="" cols='30' rows='5' placeholder='Enter your message here .......' className=' bg-white w-full p-3'></textarea>
